    ...
    <div class="col-lg-12">
        <div class="card">
          <div class="card-header">
            <strong>Produk</strong> Tambah
          </div>
          <div class="card-body card-block">
            <form action="{{ route('admin.produk.simpan') }}" method="post" enctype="multipart/form-data" class="form-horizontal">
                @csrf
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9"><textarea name="deskripsi" id="textarea-input" rows="9" placeholder="Content..." class="form-control"></textarea></div>
                </div>
                <div class="row form-group">
